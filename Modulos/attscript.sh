...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://github.com/ko2x/VPSEG/blob/master/Install/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@VPSEG_bot\n"
  ...
  echo -e "  \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@VPSEG_bot\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/ko2x/VPSEG/master/VPSEG > /dev/null 2>&1
