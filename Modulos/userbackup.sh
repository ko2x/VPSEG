...
[[ -z $backbot ]] && {
	...
	echo ""
	echo -ne "\033[1;32mCHOOSE\033[1;31m ?\033[1;37m : "; read opcao
	if [[ "$opcao" = '1' ]]; then
		...
		then
			...
			sleep 2s
			echo ""
			echo -e "\033[1;33mArchive \033[1;32mbackup.vps"
	...
	if [[ "$opcao" = '2' ]]; then
		...
		then
			echo ""
			echo -e "\033[1;36mRestart backup..."
			echo ""
			sleep 2s
			...
			rm /backup.vps
			echo ""
			echo -e "\033[1;36mUsers e\033[1;36m passwords imported successfully.\033[0m"
			echo ""
			exit
		else
			echo ""
			echo -e "\033[1;33mThe file \033[1;32mbackup.vps \033[1;33mwas not found!\033[0m"
