...
fun_spn1 () {
	...
	echo -ne "\033[1;31mREMOVE FIREWALL\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
read -p "$(echo -e "\033[1;32mWANT TO REMOVE FIREWALL RULES ? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
	echo ""	
	fun_spn1
	echo ""
	...
	if [[ -e /etc/openvpn/openvpn-status.log ]]; then
		...
		echo ""
		read -p "$(echo -e "\033[1;32mRESTART NOW \033[1;31m? \033[1;33m[s/n]:\033[1;37m ")" -e -i s respost
		echo ""
		if [[ "$respost" = 's' ]]; then
...
echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m BETA FUNCTION ULTILIZE AT YOUR OWN RISK"
echo ""
read -p "$(echo -ne "\033[1;32mWANT TO APPLY FIREWALL RULES ? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
echo ""
...
fun_spn2 () {
	...
	echo -ne "\033[1;32mAPPLYING FIREWALL\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
fun_spn2
echo ""
echo -e "\033[1;33mBLOCK\033[1;37m TORRENT \033[1;33mAPPLIED !\033[0m"
echo ""
echo -e "\033[1;32mFIREWALL APPLIED SUCESSED !"
sleep 3
menu
else
	sleep 1
