...
then
	...
	then
		echo -ne "\n\033[1;32mNew password for the user \033[1;33m$user\033[1;37m: "; read password
		...
		then
			...
			then
				...
				echo ""
				tput setaf 7 ; tput setab 4 ; tput bold ; echo "User logged in. Disconnected..." ; tput sgr0
				pkill -f $user
				echo "$user:$password" | chpasswd
				tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "User password $user has been changed to: $password" ; echo "" ; tput sgr0
				echo "$password" > /etc/SSHPlus/senha/$user
		...
		tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "O user $user not existed!" ; echo "" ; tput sgr0
	fi
fi