...
then
	echo ""
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "Erro,  Empty or invalid username! " ; tput sgr0
	exit 1
fi
...
then
	...
	then
	    echo ""
	    echo -e "\033[1;31mEX:\033[1;33m(\033[1;32mDATA: \033[1;37mDay/Month/year \033[1;33mOr \033[1;32mDAYS: \033[1;37m30\033[1;33m)"
	    echo ""
		...
		then
			...
			then
				echo ""
				tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered an invalid or non-existent date!" ; echo "Enter a valid date in DAY / MONTH / YEAR format " ; echo "exemple: 21/04/2022" ; tput sgr0 ; tput sgr0
				echo ""
				exit 1	
			else
				...
				then
					...
					then
						echo ""
						tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered a past date or the current day!" ; echo "Enter a future and valid date in DAY / MONTH / YEAR format" ; echo "exemplE: 21/04/2018" ; tput sgr0
						echo ""
						exit 1
					else
					...
					echo ""
					tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered an invalid or non-existent date!" ; echo "Enter a valid date in DAY / MONTH / YEAR format" ; echo " exempE: 21/04/2018" ; tput sgr0
					echo ""
					exit 1
				fi
			fi
			...
			echo ""
			tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered an invalid or non-existent date!" ; echo "Enter a valid date in DAY / MONTH / YEAR format" ; echo "exemplE: 21/04/2018" ; tput sgr0
			echo ""
			exit 1
		fi
	else
		echo " "
		tput setaf 7 ; tput setab 1 ; tput bold ;	echo "USERS $usuario NOT EXISTITED!" ; tput sgr0
		echo " "
		exit 1
	fi
fi
