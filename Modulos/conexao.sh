...
[ ! -f /dsds/s ] && {
	...
	inst_sqd() {
		if netstat -nltp | grep 'squid' 1>/dev/null 2>/dev/null; then
			...
			if [[ -d "/etc/squid/" ]]; then
				...
				echo -e "\n\033[1;31mERROR ! SQUID PROXY wrong\033[0m"
				sleep 2
				fun_conexao
			fi
			cat <<-EOF >$var_pay
	...
	rempt_sqd() {
		...
		echo -ne "\033[1;32WHICH PORT DO YOU WANT TO REMOVE \033[1;33m?\033[1;37m "
		read pt
		[[ -z "$pt" ]] && {
			echo -e "\n\033[1;31mPort invalid!"
			sleep 2
		...
		if grep -E "$pt" $var_sqd >/dev/null 2>&1; then
			...
			echo ""
			fun_bar 'service squid restart' 'service squid3 restart'
			echo -e "\n\033[1;32mSUCCESSFULLY REMOVED PORT!"
			sleep 3.5s
			clear
			fun_squid
		else
...
[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mBACK\033[0m"
		echo ""
		echo -ne "\033[1;32WHAT YOU WANT TO DO \033[1;33m?\033[1;31m?\033[1;37m "
		read x
		clear
		case $x in
		1 | 01)
	...
	fun_drop() {
		if netstat -nltp | grep 'dropbear' 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -ne "\033[1;32mWHAT YOU WANT TO DO \033[1;33m?\033[1;37m "
			read resposta
			if [[ "$resposta" = '1' ]]; then
				clear
				if ps x | grep "limiter" | grep -v grep 1>/dev/null 2>/dev/null; then
			...
			read resposta
			[[ "$resposta" = 's' ]] && {
				echo -e "\n\033[1;33mWHICH A PORT FOR DROPBEAR !\033[0m\n"
				...
				verif_ptrs $porta
				echo -e "\n\033[1;32mINSTALLING THE DROPBEAR ! \033[0m"
				echo ""
				fun_instdrop() {
					apt-get update -y
	...
	inst_ssl() {
		if netstat -nltp | grep 'stunnel4' 1>/dev/null 2>/dev/null; then
			...
			[[ "$resposta" = 's' ]] && {
				...
				fun_bar 'ssl_certif'
				echo -e "\n\033[1;32mSTARTING THE SSL TUNNEL !\033[0m"
				echo ""
				fun_finssl() {
	...
	fun_openvpn() {
		...
		[[ $(netstat -nplt | grep -wc 'openvpn') != '0' ]] && {
			while :; do
				...
				echo -e "\033[1;31m[\033[1;36m4\033[1;31m] \033[1;37m• \033[1;33mMulti login Ovpn $mult"
				echo -e "\033[1;31m[\033[1;36m5\033[1;31m] \033[1;37m• \033[1;33mALTER HOST DNS"
				...
				1)
					...
					echo ""
					echo -ne "\033[1;32mWHICH PORT YOU WISH TO USE \033[1;33m?\033[1;37m "
					read porta
					[[ -z "$porta" ]] && {
						echo ""
					...
					verif_ptrs
					echo ""
					echo -e "\033[1;32mCHANGING THE OPENVPN PORT!\033[1;33m"
					echo ""
					fun_opn() {
					...
					fun_bar 'fun_opn'
					echo ""
					echo -e "\033[1;32mPORT CHANGED SUCCESSFULLY!\033[1;33m"
					sleep 2
					fun_conexao
					;;
				2)
					echo ""
					echo -ne "\033[1;32mWANT TO REMOVE OPENVPN \033[1;31m? \033[1;33m[y/n]:\033[1;37m "
					read REMOVE
					[[ "$REMOVE" = 'y' ]] && {
						rmv_open() {
				...
				5)
					clear
					echo -e "\E[44;1;37m        ALTER HOST DNS           \E[0m"
					echo ""
					echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mADD DNS HOST"
			...
			echo -e "\033[1;31m[\033[1;36m5\033[1;31m] \033[1;33mhurricaneElectric"
...
exit 1' >$RCLOCAL
			...
			echo -e "\033[1;32mINSTALLING OPENVPN  \033[1;31m(\033[1;33mIT CAN TAKE TIME!\033[1;31m)"
			echo ""
			...
			echo ""
			echo -e "\033[1;32mRESETTING OPENVPN"
			echo ""
			fun_bar 'fun_ropen'
			IP2=$(wget -4qO- "http://whatismyip.akamai.com/")
			if [[ "$IP" != "$IP2" ]]; then
	...
	fun_socks() {
		...
		if [[ "$resposta" = '1' ]]; then
			if ps x | grep -w proxy.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				echo -e "\033[1;32mSOCKS ENABLED SUCCESSFULLY\033[1;33m"
				sleep 3
				fun_socks
			fi
		elif [[ "$resposta" = '2' ]]; then
			if ps x | grep -w open.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				echo -e "\033[1;32msocks Disabled Successfully!\033[1;33m"
				sleep 2
				fun_socks
			else
				clear
			...
			if ps x | grep proxy.py | grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				echo -ne "\033[1;32WHICH PORT YOU WANT TO USE \033[1;33m?\033[1;37m: "
				read porta
				[[ -z "$porta" ]] && {
					echo ""
					echo -e "\033[1;31mInvalid PORT!"
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mBACK\033[0m"
		...
		if [[ "$resp" = '1' ]]; then
			...
			clear
			echo -e "\E[41;1;37m         REMOVE PORT FROM SSH         \E[0m"
			...
			echo -ne "\033[1;32mWHICH PORT YOU WISH TO REMOVE \033[1;33m?\033[1;37m "
			read pt
			[[ -z "$pt" ]] && {
				echo -e "\n\033[1;31mPort invalid!"
				sleep 2
	...
	fun_sslh() {
		[[ "$(netstat -nltp | grep 'sslh' | wc -l)" = '0' ]] && {
			...
			echo -ne "\033[1;32mREALLY WANTS TO INSTALL SSLH \033[1;31m? \033[1;33m[y/n]:\033[1;37m "
			read resp
			[[ "$resp" = 'y' ]] && {
				verif_ptrs 443
				fun_instsslh() {
			...
			echo -ne "\033[1;32mREALLY WISH TO REMOVE SSLH \033[1;31m? \033[1;33m[y/n]:\033[1;37m "
			read respo
			[[ "$respo" = "y" ]] && {
				fun_delsslh() {
