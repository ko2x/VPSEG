...
if netstat -nltp|grep 'squid' 1>/dev/null 2>/dev/null;then
	...
	echo ""
	echo -ne "\033[1;32mREALLY WISH TO REMOVE SQUID \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resp
	if [[ "$resp" = 's' ]]; then
		echo -e "\n\033[1;32mREMOVEING SQUID PROXY !\033[0m"
		echo ""
		rem_sqd () 
		{
		if [[ -d "/etc/squid/" ]]; then
	    ...
	    fun_bar 'rem_sqd'
		echo -e "\n\033[1;32mSQUID REMOVED SUCESSED !\033[0m"
		sleep 3.5s
		clear
		fun_conexao
	else
...
if [[ -z "$ipdovps" ]];then
echo -e "\n\033[1;31mIP invalid\033[1;32m"
echo ""
read -p "Enter your IP: " IP
fi
echo -e "\n\033[1;33mWHICH PORT DO YOU WANT TO USE IN THE SQUID \033[1;31m?"
echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSET THE PORT IN SEQUENCE \033[1;33mEX: \033[1;37m80 8080 8799"
echo ""
echo -ne "\033[1;32mINFORM THE PORTS\033[1;37m: "; read portass
if [[ -z "$portass" ]]; then
	echo -e "\n\033[1;31mPort INVAILD!"
	sleep 3
	fun_conexao
fi
...
rempt_sqd () {
	...
	if [[ -f "/etc/squid/squid.conf" ]]; then
		...
		echo -e "\n\033[1;31mSQUID IS NOT INSTALLED!\033[0m"
		echo -e "\n\033[1;31mREUTRUN...\033[0m"
		sleep 2
		clear
		fun_squid
	fi
	echo -ne "\033[1;32mWHICH PORTS YOU WISH TO REMOVE \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mPorta invalid!"
		sleep 2
		clear
		fun_conexao
	fi
	if grep -E "$pt" $var_sqd > /dev/null 2>&1; then
		echo -e "\n\033[1;32mREMOVEND PORTA DO SQUID!"
		echo ""
		...
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32mSUCCESSFULLY REMOVE PORT!"
		sleep 3.5s
		clear
		fun_squid
	else
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		if [[ "$resposta" = '1' ]]; then
			...
			echo ""
			echo -ne "\033[1;32mWHICH PORT YOU WISH TO USE \033[1;33m?\033[1;37m "; read pt
			echo ""
			verif_ptrs $pt
			...
			echo -e "\n\033[1;32mSUCCESSFULLY!"
			sleep 3
			clear
			fun_conexao
		elif [[ "$resposta" = '3' ]]; then
			echo -e "\n\033[1;32mREMOVE DROPBEAR !\033[0m"
			echo ""
			fun_dropunistall () {
		...
		echo -e "\n\033[1;33mYOU ARE GOING TO INSTALL DROPBEAR !\033[0m\n"
		echo -ne "\033[1;32mDO YOU WANT TO CONTINUE \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resposta
		if [[ "$resposta" = 's' ]]; then
			...
			fun_ports () {
				...
				sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 110 -p 115 -p 443 -p 442"/g' /etc/default/dropbear > /dev/null 2>&1
			}
			echo ""
			echo -e "\033[1;32mCONFIGURAND PORT DROPBEAR !\033[0m"
			echo ""
			fun_bar 'fun_ports'
			...
			echo""
			echo -e "\033[1;31mREUTRUN\033[0m"
			sleep 3
			clear
			fun_conexao
		fi
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mSUCCESSFULLY CHANGED PORT !" || echo -e "\033[1;31mERRO INESPERADO!"
	sleep 3.5s
	clear
	fun_conexao
	fi
	if [[ "$resposta" = '2' ]]; then
		echo -e "\033[1;32mREMOVE  SSL TUNNEL !\033[0m"
		del_ssl () {
		...
		fun_bar 'del_ssl'
		echo ""
		echo -e "\033[1;32mSSL TUNNEL REMOVED SUCESS!\033[0m"
		sleep 3
		fun_conexao
	else
	...
	clear
	echo -e "\E[44;1;37m           INSTALLING SSL TUNNEL             \E[0m"
	...
	echo ""
	read -p "$(echo -e "\033[1;32mWHICH PORT YOU WISH TO USE? \033[1;37m")" -e -i 3128 porta
	if [[ -z "$porta" ]]; then
		echo ""
	...
	echo -e "\n\033[1;32mCONFIGURAN  SSL TUNNEL !\033[0m"
	echo ""
	ssl_conf () {
    ...
    echo -e "\n\033[1;32mSSL TUNNEL INSTALLED  SUCESSED !\033[1;31m PORT: \033[1;33m$porta\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mOVPN BY LINK $ovpnweb"
		...
		echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mRETURN"
		echo ""
		...
		case $option in
			...
			verif_ptrs
			echo ""
			echo -e "\033[1;32mCHANGING PORT OPENVPN!\033[1;33m"
			echo ""
			fun_opn () {
		    ...
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mPORTA CHANGED SUCESSED!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
			...
			if [[ "$REMOVE" = 's' ]]; then
			    ...
			    echo ""
			    echo -e "\033[1;32mREMOVEING OPENVPN!\033[0m"
			    echo ""
			    fun_bar 'rmv_open'
				echo ""
				echo -e "\033[1;32mOPENVPN REMOVED SUCESSED!\033[0m"
				sleep 3
				fun_conexao
			else
				echo ""
			...
			if [[ "$resp" = '1' ]]; then
				...
				echo ""
				echo -ne "\033[1;32mSelect the host to be removed \033[1;33m[\033[1;37m1\033[1;31m-\033[1;37m$i\033[1;33m]\033[1;37m: " ; read option
				if [[ -z $option ]]; then
					echo ""
			    ...
			    echo -e "\n\033[1;32mCHANGING ARCHIVE \033[1;37m/etc/hosts\033[0m"
			    echo -e "\n\033[1;31mATENCAO!\033[0m"
			    echo -e "\n\033[1;33mTO SAVE USE THE KEYS \033[1;32mctrl x y\033[0m"
			    sleep 4
			    clear
			    nano /etc/hosts
			    echo -e "\n\033[1;32mCHANGED SUCCESSFULLY!\033[0m"
			    sleep 3
			    fun_openvpn
			elif [[ "$resp" = '0' ]]; then
				echo ""
	...
	echo -e "\033[1;33mANSWER THE QUESTIONS TO START INSTALLATION"
	echo ""
	...
	echo ""
	read -p "$(echo -e "\033[1;32mWHICH PORT YOU WISH TO USE? \033[1;37m")" -e -i 1194 porta
	if [[ -z "$porta" ]]; then
				echo ""
	...
	echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;33mTCP (\033[1;32mRecomendED\033[1;33m)"
	echo ""
...
exit 0' > $RCLOCAL
	...
	echo -e "\033[1;32mINSTALLING OPENVPN  \033[1;31m(\033[1;33mMAY TAME TIME!\033[1;31m)"
	echo ""
	fun_bar 'fun_dep'
...
[\033[1;36m07\033[1;31m] \033[1;37m• \033[1;33mSSLH MULTIPLEX(NOT TRANSLATED) $sts7\033[1;31m
[\033[1;36m08\033[1;31m] \033[1;37m• \033[1;33mRETURN \033[1;32m<\033[1;33m<\033[1;31m< \033[1;31m
